#If your action is depend upon something, in that case if...else will help you.
#if...else is used to check particular condition and depend on that condition it will take action.
...
#get input from user and check condition
